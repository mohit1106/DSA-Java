...
public class maxHeap {
    static class Heap{
        ...
        private void heapify(int i){
            int left = 2*i+1;
            int right = 2*i+2;
            int maxIdx = i; //idx of minimum value i.e root - assuming

            if(left < arr.size() && arr.get(maxIdx) < arr.get(left)){  // // left < arr.size() - for leaf nodes, left and right dont exist 
                maxIdx = left;
            } 
